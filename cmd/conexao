...
[[ $(awk -F" " '{print $2}' /usr/lib/licence) == "@CRAZY_VPN" ]] && {
	...
	inst_sqd() {
		if netstat -nltp | grep 'squid' 1>/dev/null 2>/dev/null; then
			...
			echo ""
			echo -ne "\033[1;32mREALLY WISH TO REMOVE SQUID \033[1;31m? \033[1;33m[y/n]:\033[1;37m "
			read resp
			[[ "$resp" = 'y' ]] && {
			...
			echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mSET THE DOORS IN SEQUENCE \033[1;33mEX: \033[1;37m80 8080 8799"
			echo ""
			...
			if [[ -d "/etc/squid/" ]]; then
				...
				echo -e "\n\033[1;31mERROR ! CORRUPTED SQUID PROXY\033[0m"
				sleep 2
				fun_conexao
			fi
			cat <<-EOF >$var_pay
	...
	addpt_sqd() {
		...
		echo -ne "\033[1;32m WHICH PORT YOU WANT TO ADD \033[1;33m?\033[1;37m "
		read pt
		[[ -z "$pt" ]] && {
			echo -e "\n\033[1;31m PORT INVALID!"
			sleep 2
			clear
			fun_conexao
		}
		verif_ptrs $pt
		echo -e "\n\033[1;32m ADDING PORT TO SQUID!"
		echo ""
		sed -i "s/#Portas/#Portas\nhttp_port $pt/g" $var_sqd
		fun_bar 'sleep 2'
		echo -e "\n\033[1;32m RESTARTING SQUID!"
		echo ""
		fun_bar 'service squid restart' 'service squid3 restart'
		echo -e "\n\033[1;32m PORT ADDED SUCCESSFULLY !"
		sleep 3
		clear
		fun_squid
	}
	...
	rempt_sqd() {
		...
		if grep -E "$pt" $var_sqd >/dev/null 2>&1; then
			...
			echo ""
			fun_bar 'service squid restart' 'service squid3 restart'
			echo -e "\n\033[1;32mPORT REMOVED SUCCESSFULLY!"
			sleep 3.5s
			clear
			fun_squid
		else
...
[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mREMOVE PORTA\033[1;31m
[\033[1;36m0\033[1;31m] \033[1;37m• \033[1;33mCOME BACK\033[0m"
	...
	fun_drop() {
		if netstat -nltp | grep 'dropbear' 1>/dev/null 2>/dev/null; then
			...
			if [[ "$resposta" = '1' ]]; then
				...
				echo -e "\n\033[1;32mDROPBEAR SUCCESSFULLY REMOVED !\033[0m"
				sleep 3
				clear
				fun_conexao
			...
			[[ "$resposta" = 'y' ]] && {
				...
				echo -ne "\033[1;32mWHAT PORT \033[1;33m?\033[1;37m "
				read porta
				[[ -z "$porta" ]] && {
					echo -e "\n\033[1;31mPORT INVALID!"
					sleep 3
	...
	inst_ssl() {
		if netstat -nltp | grep 'stunnel4' 1>/dev/null 2>/dev/null; then
			...
			echo ""
			echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mACHANGE SSL TUNNEL PORT\033[0m"
			...
			[[ "$resposta" = 'y' ]] && {
				...
				echo ""
				read -p "$(echo -e "\033[1;32mWHICH DOOR DO YOU WANT TO USE? \033[1;37m")" -e -i 3128 porta
				[[ -z "$porta" ]] && {
					echo ""
					echo -e "\033[1;31mPort invalid!"
					sleep 3
		...
		[[ $(netstat -nplt | grep -wc 'openvpn') != '0' ]] && {
			while :; do
				...
				1)
					...
					verif_ptrs
					echo ""
					echo -e "\033[1;32mCHANGING THE OPENVPN DOOR!\033[1;33m"
					echo ""
					fun_opn() {
				...
				2)
					echo ""
					echo -ne "\033[1;32mWISH TO REMOVE OPENVPN \033[1;31m? \033[1;33m[y/n]:\033[1;37m "
					read REMOVE
					[[ "$REMOVE" = 'y' ]] && {
						rmv_open() {
				...
				5)
					...
					if [[ "$resp" = '1' ]]; then
						...
						clear
						echo -e "\E[44;1;37m            Remove DNS Host            \E[0m"
						echo ""
						echo -e "\033[1;33mList of current hosts:\033[0m "
						echo ""
						i=0
			...
			echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;33mGoogle (\033[1;32mRecomended\033[1;33m)"
			...
			echo ""
			read -p "$(echo -e "\033[1;32mWHICH PROTOCOL YOU WANT TO USE IN OPENVPN? \033[1;37m")" -e -i 2 resp
			if [[ "$resp" = '1' ]]; then
				PROTOCOL=udp
			elif [[ "$resp" = '2' ]]; then
				PROTOCOL=tcp
...
exit 0' >$RCLOCAL
	...
	fun_socks() {
		...
		echo -e "\033[1;31m[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mOPEN THE PORT\033[0m"
		...
		if [[ "$resposta" = '1' ]]; then
			...
			if ps x | grep proxy.py | grep -v grep 1>/dev/null 2>/dev/null; then
				...
				verif_ptrs $porta
				echo ""
				echo -e "\033[1;32mSTARTING PROXY SOCKS AT PORT \033[1;31m$porta\033[1;33m"
				echo ""
				abrirptsks() {
					sleep 1
					screen -dmS proxy python /etc/SSHPlus/proxy.py $porta
			...
			if ps x | grep -w proxy.py | grep -v grep 1>/dev/null 2>/dev/null; then
				...
				echo ""
				echo -ne "\033[1;32mWHAT COLOR\033[1;31m ?\033[1;37m : "
				read sts_cor
				...
				echo ""
				echo -e "\033[1;32mRESTARTING PROXY SOCKSsockspt!"
				echo ""
...
[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mCOME BACK\033[0m"
		...
		if [[ "$resp" = '1' ]]; then
			...
			clear
			echo -e "\E[41;1;37m         REMOVE PORTO TO SSH         \E[0m"
			echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mSTANDARD PORT \033[1;37m22 \033[1;33mCAUTION !\033[0m"
			echo -e "\n\033[1;33mPORTA IN USE: \033[1;37m$(grep 'Port' /etc/ssh/sshd_config | cut -d' ' -f2 | grep -v 'no' | xargs)\n"
			echo -ne "\033[1;32mWHICH PORT YOU WISH TO REMOVE \033[1;33m?\033[1;37m "
			read pt
			[[ -z "$pt" ]] && {
				echo -e "\n\033[1;31mPort invalid!"
	...
	fun_conexao() {
		while true $x != "ok"; do
			...
			[[ "$(netstat -tlpn | grep 'openvpn' | wc -l)" != '0' ]] && {
				echo -e "\033[1;32mSERVIC: \033[1;33mOPENVPN: \033[1;32mPORT: \033[1;37m$(netstat -nplt | grep 'openvpn' | awk {'print $4'} | cut -d: -f2 | xargs)"
				sts5="\033[1;32m◉ "
			} || {
				sts5="\033[1;31m○ "
			}
			...
			[[ "$(netstat -tlpn | grep 'python' | wc -l)" != '0' ]] && {
				echo -e "\033[1;32mSERVIC: \033[1;33mPROXY SOCKS \033[1;32mPORT: \033[1;37m$(netstat -nplt | grep 'python' | awk {'print $4'} | cut -d: -f2 | xargs)"
				sts4="\033[1;32m◉ "
			} || {
				sts4="\033[1;31m○ "
			}
			[[ -e "/etc/stunnel/stunnel.conf" ]] && {
				echo -e "\033[1;32mSERVIC: \033[1;33mSSL TUNNEL \033[1;32mPORT: \033[1;37m$(netstat -nplt | grep 'stunnel' | awk {'print $4'} | cut -d: -f2 | xargs)"
				sts3="\033[1;32m◉ "
			} || {
				sts3="\033[1;31m○ "
			}
			[[ "$(netstat -tlpn | grep 'dropbear' | wc -l)" != '0' ]] && {
				echo -e "\033[1;32mSERVIC: \033[1;33mDROPBEAR \033[1;32mPORT: \033[1;37m$(netstat -nplt | grep 'dropbear' | awk -F ":" {'print $4'} | xargs)"
				sts2="\033[1;32m◉ "
			} || {
				sts2="\033[1;31m○ "
			}
			[[ "$(netstat -tlpn | grep 'squid' | wc -l)" != '0' ]] && {
				echo -e "\033[1;32mSERVIC: \033[1;33mSQUID \033[1;32mPORT: \033[1;37m$(netstat -nplt | grep 'squid' | awk -F ":" {'print $4'} | xargs)"
				sts1="\033[1;32m◉ "
			} || {
				sts1="\033[1;31m○ "
			}
...
[\033[1;36m00\033[1;31m] \033[1;37m• \033[1;33mGET OUT / EXIT \033[1;32m<\033[1;33m<\033[1;31m< \033[0m"
			echo ""
			echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
			echo ""
			tput civis
